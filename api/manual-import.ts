/**
 * Manual trigger endpoint for testing the fuel data import
 * 
 * Usage: 
 * - Local: http://localhost:3000/api/manual-import
 * - Production: https://your-domain.vercel.app/api/manual-import
 */
...
export default async function handler(
  ...
  console.log('\n🔄 Manual fuel price import triggered...');
  ...
  try {
    ...
    const CSV_URL = process.env.FUEL_DATA_CSV_URL || 
      `${process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'http://localhost:3000'}/UpdatedFuelPrice-1770048000015.csv`;
